...
## Introduction
:question: I paraphrased the quotes in the fantasy football section, should i leave the "@ref1" or do i not need the reference just the entry in the .bib file?
### Fantasy Football 
